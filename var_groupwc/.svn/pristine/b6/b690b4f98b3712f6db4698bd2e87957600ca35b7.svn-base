...
MySQL msql, msql_device, msql_execute;
...
void serialEvent(Serial myPort) { 
  ...
  if (list[0]==111) {
    ...
    if ( msql.connect() )
    {
      ...
      //Motas
      //1
      msql.query( "SELECT COUNT( * ) AS total FROM devices WHERE id_mote="+list[1]+" AND read_order=1");
      msql.next();
      total=msql.getInt("total");
      if (total>0) {
      msql.query( "SELECT id_device FROM devices WHERE id_mote="+list[1]+" AND read_order=1");
      while (msql.next()) {
        int id_device_mote=msql.getInt("id_device");
        msql_execute.execute("UPDATE devices SET default_value="+list[2]+" WHERE id_device="+id_device_mote+" LIMIT 1");
        println("INSERT INTO volatile (id_volatile, id_device, date, value) VALUES('',"+id_device_mote+", UNIX_TIMESTAMP(NOW()), "+list[2]+")");
        msql_execute.execute("INSERT INTO volatile ( id_device, date, value) VALUES ("+id_device_mote+", UNIX_TIMESTAMP(NOW()), "+list[2]+")");
        msql_execute.execute("INSERT INTO records ( id_device, date, value) VALUES ("+id_device_mote+", UNIX_TIMESTAMP(NOW()), "+list[2]+")");
      }
      }
      
      //2
      msql.query( "SELECT COUNT( * ) AS total FROM devices WHERE id_mote="+list[1]+" AND read_order=2");
      msql.next();
      total=msql.getInt("total");
      if (total>0) {
      msql.query( "SELECT id_device FROM devices WHERE id_mote="+list[1]+" AND read_order=2");
      while (msql.next()) {
        int id_device_mote=msql.getInt("id_device");
        msql_execute.execute("UPDATE devices SET default_value="+list[3]+" WHERE id_device="+id_device_mote+" LIMIT 1");
        println("INSERT INTO volatile (id_volatile, id_device, date, value) VALUES('',"+id_device_mote+", UNIX_TIMESTAMP(NOW()), "+list[3]+")");
        msql_execute.execute("INSERT INTO volatile ( id_device, date, value) VALUES ("+id_device_mote+", UNIX_TIMESTAMP(NOW()), "+list[3]+")");
        msql_execute.execute("INSERT INTO records ( id_device, date, value) VALUES ("+id_device_mote+", UNIX_TIMESTAMP(NOW()), "+list[3]+")");
      }
      }
      
      //3
      msql.query( "SELECT COUNT( * ) AS total FROM devices WHERE id_mote="+list[1]+" AND read_order=3");
      msql.next();
      total=msql.getInt("total");
      if (total>0) {
      msql.query( "SELECT id_device FROM devices WHERE id_mote="+list[1]+" AND read_order=3");
      while (msql.next()) {
        int id_device_mote=msql.getInt("id_device");
        msql_execute.execute("UPDATE devices SET default_value="+list[4]+" WHERE id_device="+id_device_mote+" LIMIT 1");
        println("INSERT INTO volatile (id_volatile, id_device, date, value) VALUES('',"+id_device_mote+", UNIX_TIMESTAMP(NOW()), "+list[4]+")");
        msql_execute.execute("INSERT INTO volatile ( id_device, date, value) VALUES ("+id_device_mote+", UNIX_TIMESTAMP(NOW()), "+list[4]+")");
        msql_execute.execute("INSERT INTO records ( id_device, date, value) VALUES ("+id_device_mote+", UNIX_TIMESTAMP(NOW()), "+list[4]+")");
      }
      }
    }
  }
